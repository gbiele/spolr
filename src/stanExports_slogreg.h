...
namespace model_slogreg_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_slogreg");
    reader.add_event(21, 19, "end", "model_slogreg");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_slogreg : public prob_grad {
private:
        int N;
        std::vector<int> Y;
        int K;
        ...
        double sd_prior_b;
public:
    model_slogreg(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_slogreg_namespace::model_slogreg";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(bernoulli_logit_glm_log(Y, X, Intercept, b));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_slogreg_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_slogreg_namespace::model_slogreg stan_model;
