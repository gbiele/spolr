...
namespace model_sgauss_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_sgauss");
    reader.add_event(23, 21, "end", "model_sgauss");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_sgauss : public prob_grad {
private:
        int N;
        vector_d Y;
        int K;
        ...
        double sd_prior_b;
public:
    model_sgauss(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_sgauss_namespace::model_sgauss";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(student_t_log(sigma, 3, 0, 10));
            current_statement_begin__ = 20;
            lp_accum__.add(normal_id_glm_log(Y, X, Intercept, b, sigma));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_sgauss_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_sgauss_namespace::model_sgauss stan_model;
